        ...
        .state 'authenticated.main.audit.client.index',
            ...
            views:
                ...
                'content@authenticated':
                    templateUrl: 'auditing/events.html'
                    controller: [
                        '$scope', 'events', '$humane', '$modal', '$http', '$state', ($scope, events, $humane, $modal, $http, $state) ->
                            ...
                            $scope.viewDetails = (event) ->
                                modal = $modal.open
                                    templateUrl: 'auditing/_modal_view_confirmation_detail.html'
                                    controller: [
                                        '$scope', ($scope) ->
                                            $scope.Options =
...
#                                if $scope.filterWithParking then parkingFilter = '> 0'
                                ...
                                $scope.filterModel =
                                    ...
                                    company_name: $scope.filterValue
...
##            views:
##                'content@authenticated':
##                    templateUrl: 'events/client_index.html'
##                    controller: [
##                        '$scope', 'events', '$humane', '$modal', '$http', '$state', ($scope, events, $humane, $modal, $http, $state) ->
##                            $scope.data = events.data
##
