angular.module('thms.services').service('Russel_Peters', ['$rootScope', 'Restangular', 'Auth', '$stateParams', function($rootScope, Restangular, Auth, $stateParams) {

    this.russel_peters = true;
    ...
    this.menus = [
        {
            ...
            sections: [
                ...
                },
                {
                    name: "Main Course",
                    items: [
                        {name: "Honey glazed ham with soy & sautéed vegetable medley"},
                        {name: "Tandoori spiced chicken Maryland with fragrant rice, fried onion & coriander yoghurt"},
                        {name: "Mixed leaf salad"},
                        {name: "Peppered potato salad with fried onion, shallot & dijon mustard"},
