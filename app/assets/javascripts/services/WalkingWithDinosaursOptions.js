angular.module('thms.services').service('Walking_With_Dinosaurs', ['$rootScope', 'Restangular', 'Auth', '$stateParams', function($rootScope, Restangular, Auth, $stateParams) {

    this.walking_with_dinosaurs = true;
            ...
            sections: [
                {
                    name: "On Arrival",
                    items: [
                        {name: "Freshly brewed coffee & tea selection"},
                        {name: "Assorted filled sandwiches"},
                        {name: "Ham, cheese & tomato | Egg, lettuce & mayonnaise"},
                        {name: "Cheese & tomato | Chicken, lettuce & mayonnaise"},
                        {name: "Mini hot dogs"},
                        {name: "Mini sausage rolls with tomato sauce"},
                        {name: "Herb crumbed chicken tenders with lime aioli"},
                        {name: "Assorted Krispy Kreme Doughnuts"},
                    ]
                }
            ]
        },
            ...
            sections: [
                {
                    name: "On Arrival",
                    items: [
                        {name: "Cheezels & assorted Kettle crisps"},
                        {name: "Freshly brewed coffee & tea selection"}
                    ]
                }, {
                    ...
                    name: "Main Course",
                    items: [
                        {name: "Braised beef cheeks with rosemary roasted potato & a red wine, tomato jus"},
                        {name: "Cajun spiced chicken breast with grilled corn & harissa butter"},
        ...
        sections: [
            ...
            },
            {
                ...
                items: [
                    ...
                    {
                        name: "Vegetarian arancini with lemon aioli",
                        description: "24 per platter",
                        price_cents: 6000
                    }
                ]
