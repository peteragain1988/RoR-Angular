angular.module('thms.services').service('Drake', ['$rootScope', 'Restangular', 'Auth', '$stateParams', function($rootScope, Restangular, Auth, $stateParams) {
            ...
            sections: [
                {
                    ...
                    items: [
                        ...
                        //{name: "Assorted sushi with dipping sauce"},
                        //{name: "Matua Estate Lands & Legends Sauvignon Blanc", drink: true},
                        //{name: "Abel's Tempest Pinot Noir", drink: true}
                    ]
                },
                {
                    name: "Main Course",
                    items: [
                        {name: "Seared beef fillet with mushroom ragout & grilled asparagus"},
                        //{name: "Abel’s Tempest Pinot Noir", drink: true},
                        {name: "Thai curried chicken shanks with chilli, coriander & sprouts & fragrant jasmine rice"},
                        //{name: "Leo Buring Premium Regional Leopold Riesling", drink: true},
                        ...
                        {name: "Sweet potato with harissa yoghurt, frisse & slivered almonds"},
                ...
                },
                {
                    ...
                    items: [
                        ...
                        //{name: "Caramelised pineapple & coconut panna cotta"},
                        //{name: "White forest"},
            ...
            sections: [
                {
                    ...
                    items: [
                        ...
                        //{name: "T’Gallant Grace Pinot Grigio", drink: true},
                    ]
                },
                {
                    name: "Main Course",
                    items: [
                        {name: "Greek style lamb with white wine & sautéed beans with asparagus & yoghurt dressing"},
                        //{name: "Baileys of Glenrowan Cabernet Sauvignon", drink: true},
                        {name: "Soy glazed chicken marylands with fried rice & coriander"},
                        //{name: "Matua Estate Series Lands & Legends Sauvignon Blanc", drink: true},
                        //{name: "Deli meat platter"},
                        //{name: "Wagyu pastrami, tartufo salami, smoked turkey breast & nduja tradizionale with croutes"},
                        //{name: "Roma tomato, pickled fennel & onion salad with aged balsamic reduction"},
                        //{name: "Asparagus, baby corn & rice salad with coriander & soy dressing"},
                        {name: "Mixed leaf salad"},
                        {name: "Roma tomato with bocconcinni, basil & pesto dressing"},
                        {name: "Fresh bread selection"}
                    ]
                },
                {
                    ...
                    items: [
                        ...
                        //{name: "Mango mousse"},
                        {name: "Trio of Australian cheeses with dried fruit, nuts, crisp bread & lavosh"},
                        {name: "Assorted Streets Magnum ice creams"},
                        {name: "Freshly brewed coffee & tea selection with chocolates"}
                    ]
                }
            ]
