angular.module('thms.services').service('Ricky_Martin', ['$rootScope', 'Restangular', 'Auth', '$stateParams', function($rootScope, Restangular, Auth, $stateParams) {

    this.ricky_martin = true;
            ...
            sections: [
                {
                    name: "On Arrival",
                    items: [
                        {name: "Panne de casa with green olive tapenade, Persian fetta & salsa"}
                    ]
                },
                {
                    name: "Main Course",
                    items: [
                        {name: "Lamb rump with garlic potato wedges, gremolata & red currant jus"},
                        {name: "Atlantic salmon with teriyaki dressing & sesame infused bok choy    "},
                        {name: "Antipasto platter"},
                        {name: "Sliced Capocollo, ricotta stuffed peppers, marinated boconcini, semi dried tomatoes, grilled asparagus with fennel & balsamic"},
                        {name: "Mixed leaf salad"},
                        {name: "Mushroom medley with corn, shallots & flat leaf parsley"},
            ...
            sections: [
                {
                    name: "On Arrival",
                    items: [
                        {name: "Chicken liver parfait & red pepper dip with toasted ciabatta"}
                    ]
                },
                {
                    name: "Main Course",
                    items: [
                        {name: "Slow roasted beef medallions with rendang sauce & snap peas with sautéed red peppers"},
                        {name: "Marinated chicken shanks with jasmine rice & fried onion"},
                        {name: "Gourmet deli meat platter of wagyu pastrami, tartufo salami, smoked turkey breast & roast pork loin with croutes"},
                        {name: "Mixed leaf salad"},
                        {name: "Roma tomato, pickled fennel, onion & aged balsamic reduction"},
                        {name: "Asparagus, baby corn rice salad with coriander & soy dressing"},
                        {name: "Fresh bread selection"}
                    ]
                },
                {
                    name: "Dessert",
                    items: [
                        {name: "Banana custard with fresh berries & pastry crisp"},
                        {name: "Mango mousse"},
                        {name: "Trio of Australian cheeses with dried fruit, nuts, crisp bread & lavosh"},
        ...
        sections: [
            {
                ...
                items:[
                    {
                        name: "Kettle Sea Salt Crisps",
                        price_cents: 480
                    },
                    {
                        name: "Kettle Sea Salt & Vinegar Crisps",
                        price_cents: 480
                    },
                    {
                        name: "Kettle Chilli Crisps",
                        price_cents: 480
                    },
                    {
                        name: "Cheezels",
                    ...
                    {
                        name: "Herb focaccia fingers with pesto & chilli tomato salsa",
                        price_cents: 7000
                    },
                    {
                        name: "Antipasto platter",
                        price_cents: 7000,
                        description: "Sliced Capocollo, ricotta stuffed peppers, marinated boconcini, semi dried tomatoes, grilled asparagus with fennel & balsamic"
                    },
                    {
                        name: "Gourmet deli platter",
                        price_cents: 10000,
                        description: "Wagyu pastrami, tartufo salami, smoked turkey breast & roast pork loin with croutes"
                    },
                    {
                        name: "Fresh king prawns & oysters with trio of dipping sauces",
                        price_cents: 30000
                    },
                    {
                        name: "Freshly brewed coffee & tea service",
                        price_cents: 6500,
                        description: "with cookies 18pax"
                    }
                ]
            },
            {
                ...
                items: [
                    ...
                    {
                        name: "Vegetarian arancini with grated grana padano",
                        description: "24 per platter",
                        price_cents: 6000
                    }
                ]
            },
            {
                ...
                items: [
                    ...
                    {
                        name: "Streets Magnum Original",
                        price_cents: 470
                    },
                    {
                        name: "Streets Magnum White",
                        price_cents: 470
                    },
                    {
                        name: "Streets Magnum Almond",
                        price_cents: 470
                    },
                    {
                        name: "Streets Magnum Chocolate Truffle ",
                        price_cents: 470
                    },
                    {
