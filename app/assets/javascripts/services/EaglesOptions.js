angular.module('thms.services').service('The_Eagles', ['$rootScope', 'Restangular', 'Auth', '$stateParams', function($rootScope, Restangular, Auth, $stateParams) {

    this.the_eagles = true;
    ...
    this.menus = [
        {
            ...
            sections: [
                ...
                },
                {
                    name: "Main Course",
                    items: [
                        {name: "Veal medallions with portobello mushrooms & white wine sauce, crushed chats with fresh herbs"},
                        //{name: "Abel’s Tempest Pinot Noir", drink: true},
                        {name: "Corn-fed chicken breast with tomato & red pepper salsa, sautéed snow peas & broccolini"},
                        //{name: "Leo Buring Premium Regional Leopold Riesling", drink: true},
                        {name: "Seared duck breast with orange glaze & duck rice paper roll platter with dipping sauce"},
                        {name: "Mixed leaf salad"},
                        {name: "Vine ripened tomato, coriander & salsa verde"},
                        {name: "Chickpea with spiced eggplant & shallots with harissa dressing"},
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {name: "Berry trifle with brandied custard"},
                        {name: "Mont blanc"},
            ...
            sections: [
                {
                    ...
                    items: [
                        {name: "CANAPÉS"},
                        {name: "Fennel crusted tuna with pickled carrot & wakame salad"},
                        {name: "Duck salad with spiced cashews & crisp vegetables"},
                        {name: "Barbeque kangaroo carpaccio, smoked tomato & blackened corn salsa"},
                ...
                },
                {
                    name: "Main Course",
                    items: [
                        {name: "Spice rubbed wagyu beef medallions with sautéed green beans & baby corn"},
                        {name: "Mini roast spatchcock with garlic butter & pancetta on saffron & ginger risotto"},
                        {name: "Fresh king prawns & oysters with trio of dipping sauces"},
                        {name: "Mixed leaf salad"},
                        {name: "Cous cous with shaved lamb peppers & lemon dressing"},
                        {name: "Penne pasta with smoked salmon & chives"},
                        {name: "Fresh bread selection"}
                    ]
                },
                {
                    ...
                    items: [
                        ...
                        {name: "Mascarpone mousse with tia maria & shaved chocolate"},
                        {name: "Upside down pavlova"},
                        {name: "Trio of Australian cheeses with dried fruit, nuts, crisp bread & lavosh"},
                        {name: "Sliced fruit platter"},
                        {name: "Freshly brewed coffee & tea selection with chocolates"}
                    ]
