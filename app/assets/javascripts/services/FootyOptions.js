angular.module('thms.services').service('FootyOptions', ['$rootScope', 'Restangular', 'Auth', '$stateParams', function($rootScope, Restangular, Auth, $stateParams) {

    this.footyFightNight = true;
    ...
    this.menus = [
        {
            ...
            sections: [
                ...
                },
                {
                    name: "Main Course",
                    items: [
                        {name: "Carved Grainge rump cap with garlic mushrooms & mustard jus"},
                        //{name: "Abel’s Tempest Pinot Noir", drink: true},
                        {name: "Roast Chicken breast with pumpkin risotto, tomato compote & asparagus"},
                        //{name: "Coldstream Hills Yarra Valley Range Chardonnay", drink: true},
                        ...
                        {name: "Creamy pasta salad with prawns, celery & chives"},
        ...
        },
        {
            ...
            sections: [
                ...
                },
                {
                    name: "Main Course",
                    items: [
                        {name: "Peppered scotch fillet with vegetable medley & red currant jus"},
                        //{name: "Pepperjack Shiraz", drink: true},
                        {name: "Pork belly with bourbon glaze, salted chats & fennel"},
                        //{name: "Matua Estate Series Lands & Legends Sauvignon Blanc", drink: true},
                        {name: "Mixed leaf salad"},
                        {name: "Saffron rice with coriander & shredded chicken"},
                        {name: "Fresh bread selection"}
                    ]
                },
                {
                    ...
                    items: [
                        //{name: "Baileys of Glenrowan Fortified Founder Series Muscat", drink: true},
                        //{name: "Baileys of Glenrowan Fortified Founder Series Topaque", drink: true},
                        //{name: "Triple chocolate mousse & glace orange"},
                        //{name: "Honey pecan"},
                        {name: "Trio of Australian cheeses with dried fruit, nuts, crisp bread & lavosh"},
