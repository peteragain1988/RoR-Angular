angular.module('thms.services').service('BillyConnolly', ['$rootScope', 'Restangular', 'Auth', '$stateParams', function($rootScope, Restangular, Auth, $stateParams) {

    this.billy_connolly = true;
